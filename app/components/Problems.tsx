...
export default function Challenges() {
  return (
    <section id="problemas" className="py-16 lg:py-20 px-6 bg-transparent relative">
      {/* Subtle top border */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-4">
          {challenges.map((problem, index) => (
            ...
            >
              <div
                className="flex flex-col md:flex-row md:items-center gap-6 md:gap-12 p-8 md:p-10 rounded-2xl border border-white/[0.06] bg-[#111827] hover:bg-[#1a2035] hover:border-cyan-500/[0.2] transition-all duration-500"
              >
                {/* Number */}
                <div className="text-5xl md:text-6xl font-light text-cyan-500/30 tabular-nums">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-3">
                    <span className="text-[11px] text-cyan-400/50 tracking-widest uppercase">
                      {problem.category}
                    </span>
                  </div>
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full border border-cyan-500/[0.15] bg-cyan-500/[0.05] flex items-center justify-center">
                    <svg
