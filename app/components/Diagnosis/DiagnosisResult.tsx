  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div className="text-center mb-8 animate-in">
        <p className="text-[#67e8f9] text-[13px] uppercase tracking-wider mb-4">
          Te recomendamos
        </p>

        {!result.hasWebsite && result.recommendedPlan && (
          <>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0891b2]/20 to-[#67e8f9]/20 border border-[#0891b2]/30 text-[#67e8f9] mb-4">
            ...
            <p className="text-[#67e8f9] font-medium text-lg mb-3">
        ...
        {result.hasWebsite && result.recommendedService && (
          <>
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-cyan-500/20 border border-white/[0.08] text-cyan-400 mb-4">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-8 animate-in">
        {!result.hasWebsite && result.recommendedPlan && (
          <div className="p-5 rounded-xl bg-gradient-to-br from-[#0891b2]/10 to-transparent border border-[#0891b2]/20">
            <div className="flex items-center gap-3 mb-2">
              <svg className="w-5 h-5 text-[#67e8f9]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <p className="text-[#67e8f9] text-[13px]">Tiempo de entrega estimado</p>
            </div>
        ...
        <div className="mb-8 animate-in">
          ...
          <div className="grid md:grid-cols-2 gap-2">
            {result.recommendedPlan.includes.map((item, index) => (
              ...
              >
                <svg className="w-4 h-4 text-[#0891b2] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mb-8 animate-in">
          ...
          <div className="flex flex-wrap gap-2">
            {result.suggestedFeatures.map((feature, index) => (
              <span
                key={index}
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#0891b2]/10 border border-[#0891b2]/20 text-[#67e8f9] text-[13px]"
              >
      ...
      <div className="mb-8 animate-in">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-[#0891b2]/20 flex items-center justify-center text-[#67e8f9] text-[12px] flex-shrink-0 mt-0.5">1</div>
            <p className="text-white/60 text-[15px]">Nos escribes por WhatsApp con tu resultado</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-[#0891b2]/20 flex items-center justify-center text-[#67e8f9] text-[12px] flex-shrink-0 mt-0.5">2</div>
            <p className="text-white/60 text-[15px]">Conversamos 10 minutos para entender mejor tu negocio</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 rounded-full bg-[#0891b2]/20 flex items-center justify-center text-[#67e8f9] text-[12px] flex-shrink-0 mt-0.5">3</div>
      ...
      <div className="text-center animate-in">
        <MagneticButton
          ...
          strength={0.4}
          className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#0891b2] to-[#67e8f9] text-white font-medium text-base rounded-full transition-all duration-500 hover:shadow-[0_0_40px_rgba(34,211,238,0.3)]"
        >
